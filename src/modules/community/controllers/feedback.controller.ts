...
export class FeedbackController {
  ...
  async submitFeedback(
    ...
    @Body() body: { prediction_id: string; isCorrect: boolean; user_submitted_label?: string; notes?: string; file_path?: string },
  ) {
  ...
  async getMyFeedbacks(
    ...
    return this.feedbackService.getFeedbacks({ username: userId }, { page, limit });
  }
  ...
  @Roles('admin', 'de')
  @Patch(':id/status')
  @ApiOperation({ summary: 'Approve or reject feedback for AI training dataset (Admin/DE)' })
  async updateFeedbackStatus(
    ...
    return this.feedbackService.updateFeedback(feedbackId, { status, admin_id: adminId, reason });
  }
}
